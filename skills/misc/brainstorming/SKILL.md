---
name: brainstorming
description: Brainstorm any idea — feature, name, business, creative direction — as an interactive back-and-forth partner, not a one-shot list dump. Trigger on "let's brainstorm", "I need ideas for X", "what are some ways to...", "I'm stuck on...", "help me name/pitch this", or an open-ended idea.
---
...
If the actual target underneath my ask isn't clear, or I've already ruled things out, ask before generating — briefly, not an interrogation. Otherwise start generating.

Spread ideas across a real range in one pass: at least one safe option, a couple of solid middle-ground ones, one genuinely bold one. Three to six per turn, a sentence or two each — more than that stops being usable.
